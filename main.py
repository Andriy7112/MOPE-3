...
d1 = sd1/m  # Коефіцієнти d1, d2, d3, d4 ми використовуємо для того щоб визначити коефіцієнт Gp(показує, яку частку в загальній сумі
d2 = sd2/m  # дисперсій у рядках має максимальна з них) і визначити чи є дисперсія однорідною.
d3 = sd3/m  # Також ці коефіцієнти потрібні для перевірки значущості коефіцієнтів та для розрахунків в критерії Фішера
d4 = sd4/m
